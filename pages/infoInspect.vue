                  ...
                  <div>
                      ...
                      >
                        <v-menu
                          ...
                          :return-value.sync="inspecteur.date_affectation"
                        ...
                        >
                          <template #activator="{ on, attrs }">
                            <v-text-field
                              v-model="inspecteur.date_affectation"
                          ...
                          >
                            ...
                            <v-btn
                              text
                              color="primary"
                              @click="$refs.menu.save(inspecteur.date_affectation)"
                            >
                              OK
                            </v-btn>
                          </v-date-picker>
  ...
  export default {    
    data () {
       ...
       async store_responsable () {
            ...
            await this.$axios.post('store-inspect',this.inspecteur).then(response => {               
                if(response.data.inspect.status === 1){
                     localStorage.setItem('inspect', response.data.user_id)             
          ...
          getData (data, value){
              ...
              //     this.niveaux = []
              //      this.$axios.defaults.headers.common.Authorization = 'Bearer ' + localStorage.getItem('authToken')
              //    this.$axios.get( 'get-zone/'+ this.inspecteur.zone_id).then( response => {
